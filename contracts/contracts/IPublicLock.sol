...
interface IPublicLock {
     ...
     */
    function keyExpirationTimestampFor(uint256 _tokenId)
        external
        view
     ...
     */
    function getTransferFee(uint256 _tokenId, uint256 _time)
        external
        view
        returns (uint256);
     ...
     */
    function getCancelAndRefundValue(address _keyOwner)
        external
        view
     ...
     */
    function totalKeys(address _keyOwner)
        external
        view
        returns (uint256 numberOfKeys);
